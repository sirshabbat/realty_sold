...
proj_dict = {"Берег Курортный": ['Глоракс Балтийская', 'Глоракс Василеостровская', 'Глоракс Премиум Василеостровская',
                                 'Резиденция Рощино', 'Лисино', 'Морская набережная', 'Нева Резиеднс', 'Аквилон Залив',
                                 'Форест Аквилон', 'Панорама Парк Сосновка', 'Репино парк', 'Модум', 'Ариосто',
                                 'Берег.Курортный',
                                 'Морская Ривьера', 'Русские сезоны', 'Мир внутри', 'Лахта парк'],
